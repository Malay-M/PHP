...
if(isset($_POST['profile'])) {
    $_SESSION['user_profile'] = $_POST['username'];
}
        ...
        <div class="container">
            ...
            <div class="profile-pic">
                ...
                <div class="profile-form">
                    ...
                    <div class="profile">
                        <img src="../Profile/Image/<?php echo $values['url']; ?>">
                    </div>
                    ...
                    <div class="image-form">
                        ...
                        <button id="remove"><a style="color: white;" href="remove_profile.php">Remove</a></button>
                    </div>
